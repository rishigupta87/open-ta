...
#             }
#         orderId=config.SMART_API_OBJ.placeOrder(orderparams)
...
#         }
#         candel_json  = config.SMART_API_OBJ.getCandleData(historicParam)
...
if __name__ == '__main__':
    ...
    tokenInfo = getTokenInfo('NIFTY','NFO','OPTIDX',18100,'PE').iloc[0]
    print(tokenInfo)
    symbol  = tokenInfo['symbol']
    token = tokenInfo['token']
